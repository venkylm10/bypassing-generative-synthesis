...
def main():
    ...
    results = [
        {
            ...
            "description": ("Mean Dice score (foreground classes: necrotic core, edema, "
                             ...
                             "3D U-Net on held-out test subjects, averaged across "
        ...
        },
        {
            ...
            "method": "latent_imputed_unet",
            "description": "Mean Dice score for the necrotic/non-enhancing core class (raw BraTS labels 1 and 3 merged), averaged across seeds.",
        ...
        },
        {
            ...
            "method": "latent_imputed_unet",
            "description": "Mean Dice score for the peritumoral edema class (raw BraTS label 2), averaged across seeds.",
        ...
        },
        {
            ...
            "method": "latent_imputed_unet",
            "description": "Mean Dice score for the enhancing tumor class (raw BraTS label 4), averaged across seeds.",
        ...
        },
        {
            ...
            "description": ("End-to-end forward-pass latency of the latent-imputed architecture "
                             "(3 real modality encoders + NMA-imputed T1ce branch + shared decoder) "
    ...
    fig1_path = os.path.join(FIGURES_DIR, "latent_imputed_dice_distribution.png")
    ...
    plt.ylabel("Count")
    plt.title(f"Dice distribution across {len(all_subject_dice)} test-subject evals ({n_seeds} seeds)")
    plt.legend()
    plt.tight_layout()
    plt.savefig(fig1_path, dpi=150)
    plt.close()
    figures.append({
        "name": "latent_imputed_dice_distribution",
    ...
    plt.title("Training curve (seed 0)")
    plt.tight_layout()
